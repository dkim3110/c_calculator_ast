 ...
 * GiB and 2 MiB each.
 * @param: sizes of virtual memory to reserve and to commit at a time.
 ...
 * @param: pointer to the allocated mem_arena struct, boolean representing if it should decommit.
 */
 ...
 * @param: size of memory in bytes.
 * @return: pointer to the reserved memory; NULL in case of failure.
 */
 ...
 * @param: pointer to virual address, size to commit in bytes.
 ...
 * @param: pointer to virual address, size to decommit in bytes.
 * @return: true if successful, false if failure.
 */
 ...
 * @param: pointer to virual address, size to release in bytes.
 * @return: true if successful, false if failure.
 */
